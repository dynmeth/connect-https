...
var Server = exports.Server = function Server(options, layers) {
  this.stack = [];
  ...
  http.Server.call(this, options, this.handle);
};
...
exports.createServer = function(options) {
  return new Server(options, Array.prototype.slice.call(arguments, 1));
};
